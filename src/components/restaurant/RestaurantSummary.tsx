      ...
      <Card className="p-4 md:p-6 bg-background border-accent">
        <div className="flex items-center gap-2 mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="px-2 py-0.5 text-xs bg-primary/10 text-primary rounded-full">AI-POWERED</span>
          </div>
        </div>
  ...
  return (
    <Card className="p-4 md:p-6 bg-background border-accent overflow-hidden hover:shadow-lg transition-shadow duration-300">
      <div className="flex items-center gap-2 mb-6">
        ...
        <div className="flex items-center gap-2">
          <h3 className="text-lg font-semibold">Personalized Restaurant Analysis</h3>
          <span className="px-2 py-0.5 text-xs bg-primary/10 text-primary rounded-full border border-primary/20">AI-POWERED</span>
        </div>
      </div>
